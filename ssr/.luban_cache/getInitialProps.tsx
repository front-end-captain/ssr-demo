...
type WrapperComponent = { getInitialProps?: (params: any) => Promise<any> } & React.ComponentType;
...
export function GetInitialProps(WrappedComponent: WrapperComponent): React.ComponentClass {
